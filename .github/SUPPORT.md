# Getting help with roundr

Thanks for using roundr. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/roundr/issues) to make sure the 
